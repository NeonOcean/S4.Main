...
CreateBugReportInteractions = list()  # type: typing.List[typing.Type[CreateBugReportInteraction]]

class CreateBugReportInteraction(Dependent.DependentExtension, Events.EventsExtension, Registration.RegistrationExtension, immediate_interaction.ImmediateSuperInteraction):
	...
	def __init_subclass__ (cls, *args, **kwargs):
		try:
			...
			CreateBugReportInteractions.append(cls)
