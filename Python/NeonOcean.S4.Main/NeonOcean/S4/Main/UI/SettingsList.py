...
from NeonOcean.S4.Main.UI import SettingsShared as UISettingsShared, Dialogs, Resources as UIResources
...
class SettingsList(SettingsListBase):
	...
	def _GetResetAllConfirmDialogYesButtonText (self) -> localization.LocalizedString:
		return Language.GetLocalizationStringByIdentifier(This.Mod.Namespace + ".Setting_Lists.Reset_All.Confirm_Dialog.Yes_Button")

	def _GetResetAllConfirmDialogNoButtonText (self) -> localization.LocalizedString:
		return Language.GetLocalizationStringByIdentifier(This.Mod.Namespace + ".Setting_Lists.Reset_All.Confirm_Dialog.No_Button")
