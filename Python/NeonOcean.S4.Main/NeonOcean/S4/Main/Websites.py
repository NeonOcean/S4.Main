...
def GetNODocumentationSimSettingURL (setting: typing.Type[AbstractSettings.SettingAbstract], mod: Mods.Mod) -> str:
	return GetNODocumentationModURL(mod) + "/settings/sim/" + setting.Key.replace("_", "-").lower()
