...
from NeonOcean.Main import Mods, SettingsShared
...
def GetNODocumentationSimSettingURL (setting: typing.Type[SettingsShared.SettingBase], mod: Mods.Mod) -> str:
	return GetNODocumentationModURL(mod) + "/settings/sim/" + setting.Key.replace("_", "-")
