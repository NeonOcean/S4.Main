...
from NeonOcean.Main.Interactions.Support import RegistrationHandler, RegistrationShared
...
class RegistrationExtension(RegistrationShared.RegistrationExtensionAbstract):
	...
	INSTANCE_TUNABLES = {
		...
		"AutomaticObjectRegistration": tunable.TunableTuple(
			...
			Sims = tunable.Tunable(description = "Whether or not the interaction will be automatically registered to all sims, this includes all humans, human babies, cats, dogs and any future creatures that use the Sim python class.", tunable_type = bool, default = False),
